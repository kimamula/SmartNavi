...
declare module "react-native" {
    ...
    export interface ProgressViewIOSProperties extends React.Props<ProgressViewIOSProperties> {
        progress?: number
    ...
    export interface ProgressBarAndroidProperties extends React.Props<ProgressBarAndroidProperties> {
        color?: string
     ...
     * @see Picker.ios.js
     */
    export interface PickerProperties extends React.Props<PickerStatic> {
    ...
    export type PickerMode = 'dialog' | 'dropdown'
    ...
    export namespace DatePickerAndroid {
        export function open(options: {
            date?: Date | number;
            minDate?: Date | number;
            maxDate?: Date | number;
        }): Promise<{action: string; year: number; month: number; day: number;}>
        export const dateSetAction: string;
        export const dismissedAction: string;
    }

    export namespace TimePickerAndroid {
        export function open(options: {
            hour?: number;
            minute?: number;
            is24Hour?: boolean;
        }): Promise<{action: string; hour: number; minute: number;}>
        export const timeSetAction: string;
        export const dismissedAction: string;
    }
