...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SmartNavi = __webpack_require__(1);

	var _SmartNavi2 = _interopRequireDefault(_SmartNavi);
	...
	var _NotFound = __webpack_require__(172);
	...
	var parent = document.getElementById('smart-navi');
	var element = _Navigator2.default.createElement(JSON.parse(parent.dataset.pathQuery), _router2.default);
	ReactDOM.render(React.createElement(_SmartNavi2.default, { router: _router2.default, initialElement: element ? element : function () {
	    return React.createElement(_NotFound2.default, null);
	  } }), parent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Navigator_1 = __webpack_require__(35);
	var StyleSheet_1 = __webpack_require__(36);

	var SmartNavi = function (_React$Component) {
	    _inherits(SmartNavi, _React$Component);

	    function SmartNavi() {
	        _classCallCheck(this, SmartNavi);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(SmartNavi).apply(this, arguments));
	    }

	    _createClass(SmartNavi, [{
	        key: 'render',
	        value: function render() {
	            return React.createElement(
	                ...
	                'SmartNavi',
	                React.createElement(Navigator_1.default, this.props)
	            );
	        }
	    }]);
	...
	var styles = StyleSheet_1.default.create({
	    container: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Navigator = function (_React$Component) {
	    ...
	    function Navigator(props) {
	        ...
	        _this.state = { currentComponent: _this.createElement(_this.props.initialElement) };
	        if (typeof window === 'undefined') {
	            return _possibleConstructorReturn(_this);
	        }
	        window.onpopstate = function (event) {
	            console.log(event.state);
	            _this.setState({ currentComponent: _this.createElement(event.state ? Navigator.createElement(event.state, _this.props.router) : _this.props.initialElement) });
	        };
	        return _this;
	    }
	    ...
	    _createClass(Navigator, [{
	        ...
	        key: 'createElement',
	        value: function createElement(elementFunction) {
	...
	(function (Navigator) {
	    function createElement(pathQuery, router) {
	        return _createElement(pathQuery, router);
	    }
	    Navigator.createElement = createElement;
	    function _createElement(params, router) {
	        if (!params.path || params.path === '/') {
	            return typeof router === 'function' ? router.bind(this, params) : typeof router[''] === 'function' ? router[''].bind(this, params) : null;
	        }
	        ...
	        var result = null;
	        if (router[firstPath]) {
	            result = _createElement(Object.assign({}, params, { path: nextPath }), router[firstPath]);
	            if (result !== null) {
	                return result;
	            }
	        }
	        Object.keys(router).some(function (path) {
	            if (path.startsWith(':')) {
	                result = _createElement({
	                    path: nextPath,
	                    query: params.query,
	                    pathParams: Object.assign({}, params.pathParams, _defineProperty({}, path.substr(1), firstPath))
	                }, router[path]);
	            }
	            return result !== null;
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var Text_1 = __webpack_require__(173);
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                ...
	                { style: this.props.style, onClick: function onClick() {
	                        return _this2.props.onPress && _this2.props.onPress();
	                    } },
	                this.props.children
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Direction_1 = __webpack_require__(175);
	var SearchForm_1 = __webpack_require__(176);
	var React = __webpack_require__(2);
	var router = {
	    '': function _(params, navigator) {
	        var _params$query = params.query;
	        var origin = _params$query.origin;
	        var destination = _params$query.destination;
	        var when = _params$query.when;
	        var time = _params$query.time;

	        return React.createElement(SearchForm_1.default, { navigator: navigator, initialState: {
	                origin: origin,
	                destination: destination,
	                when: when ? Number(when) : SearchForm_1.default.When.Depart,
	                time: time ? new Date(Number(time)) : new Date()
	            } });
	    },
	    directions: function directions(params, navigator) {
	        var _params$query2 = params.query;
	        var origin = _params$query2.origin;
	        var destination = _params$query2.destination;
	        var when = _params$query2.when;
	        var time = _params$query2.time;

	        return React.createElement(Direction_1.default, { navigator: navigator, origin: origin, destination: destination, when: Number(when), time: new Date(Number(time)) });
	    }
	};
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Direction = function (_React$Component) {
	    ...
	    function Direction() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Direction).apply(this, arguments));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var View_1 = __webpack_require__(34);
	var Picker_1 = __webpack_require__(178);
	var DatePicker_1 = __webpack_require__(179);
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(TextInput_1.default, { style: styles.input, defaultValue: origin, onChangeText: function onChangeText(origin) {
	                            return _this2.setState({ origin: origin, destination: destination, when: when, time: time });
	                        } })
	                ),
	                React.createElement(
	                    View_1.default,
	                    ...
	                    React.createElement(TextInput_1.default, { style: styles.input, defaultValue: destination, onChangeText: function onChangeText(destination) {
	                            return _this2.setState({ origin: origin, destination: destination, when: when, time: time });
	                        } })
	                ),
	                React.createElement(
	                    ...
	                    React.createElement(
	                        Picker_1.default,
	                        { style: styles.label, selectedValue: SearchForm.When[when], onValueChange: function onValueChange(when) {
	                                return _this2.setState({ origin: origin, destination: destination, when: SearchForm.When[when], time: time });
	                            } },
	                        React.createElement(Picker_1.default.Item, { value: SearchForm.When[SearchForm.When.Depart] }),
	                        React.createElement(Picker_1.default.Item, { value: SearchForm.When[SearchForm.When.Arrive] })
	                    ),
	                    React.createElement(
	                        Text_1.default,
	                        { style: styles.label },
	                    ...
	                    React.createElement(DatePicker_1.default, { date: time, mode: 'datetime', onDateChange: function onDateChange(time) {
	                            return _this2.setState({ origin: origin, destination: destination, when: when, time: time });
	                        } })
	                ),
	                React.createElement(
	...
	(function (SearchForm) {
	    (function (When) {
	        When[When["Depart"] = 0] = "Depart";
	        When[When["Arrive"] = 1] = "Arrive";
	    })(SearchForm.When || (SearchForm.When = {}));
	    var When = SearchForm.When;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextInput = function (_React$Component) {
	    ...
	    _createClass(TextInput, [{
	        key: "render",
	        value: function render() {
	            var nullFunc = function nullFunc(arg) {};var _props = this.props;
	            var style = _props.style;
	            var value = _props.value;
	            var defaultValue = _props.defaultValue;
	            var _props$onChangeText = _props.onChangeText;
	            var onChangeText = _props$onChangeText === undefined ? nullFunc : _props$onChangeText;
	            var _props$onFocus = _props.onFocus;

	            var _onFocus = _props$onFocus === undefined ? nullFunc : _props$onFocus;

	            var _props$onBlur = _props.onBlur;

	            var _onBlur = _props$onBlur === undefined ? nullFunc : _props$onBlur;

	            return React.createElement("input", { type: "text", style: style, value: value, defaultValue: defaultValue, onChange: function onChange(event) {
	...
	var Picker = function (_React$Component) {
	    ...
	    _createClass(Picker, [{
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                "select",
	                { style: this.props.style, value: this.props.selectedValue, onChange: function onChange(event) {
	                        return _this2.props.onValueChange && _this2.props.onValueChange(event.currentTarget.value);
	                    } },
	                this.props.children
	            );
	        }
	...
	var DatePicker = function (_React$Component) {
	    ...
	    _createClass(DatePicker, [{
	        ...
	        value: function render() {
	            ...
	            var typeSuffix = this.props.mode === 'datetime' ? '-local' : '';
	            return React.createElement('input', { type: this.props.mode + typeSuffix, value: ISODateString(this.props.date), min: ISODateString(this.props.minimumDate), max: ISODateString(this.props.maximumDate), onChange: function onChange(event) {
	                    return _this2.props.onDateChange && _this2.props.onDateChange(new Date(Date.parse(event.currentTarget.value)));
	                } });
	        }
	    }]);
